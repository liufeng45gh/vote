        ...
        <div class="info-fr wrapper-996">
            <div class="finance-block news-left">
                <div class="news-menu">
                    ...
                    <a href="/member-activity/index?categoryId=${category.id?default("")}"><div class="menu-item" id="menu-item-${category.id?default("")}">${category.name}</div></a>
                    </#list>
                ...
                <div class="finance-list news-list" id="news-list">
                    ...
                    <div class="news-item">
                        <#if news.isLogoHave()>
                        <div class="logo">
                            <a href="/member-activity/${news.id}/detail" target="_blank">
                ...
                <input type="hidden" id="load-more-url" value="/member-activity/list">
