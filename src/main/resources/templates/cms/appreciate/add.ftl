...
<body style="zoom: 1;">
	<div class="b-container">
        ...
        <div id="wrap">
             <div class="outer with-side with-transition" style="min-height: 600px;">
                    ...
                    <div id="admin_right">
                    			<div class="position"><span>内容管理</span><span>|</span><span>作品</span><span>|</span><span>新增</span></div>
                    			<div class="content form_content" style="width:100%">


                                    <form action="/cms/appreciate/add" method="post" id="hfc-form">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_appreciate_add").addClass("selected");
			 var ue = UE.getEditor('editor');
		});
	</script>
    <script type="text/javascript" charset="UTF-8" src="/cms/script/hfc/appreciate/add.js"></script>
