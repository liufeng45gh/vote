...
<body style="zoom: 1;">
		...
		<div id="wrap">
            <div class="outer with-side with-transition" style="min-height: 600px;">
                ...
                <div id="admin_right">
                			...
                			<div class="position"><span>内容管理</span><span>&gt;</span><span>作品</span><span>&gt;</span><span>分类</span></div>
                            ...
                            <table class="list_table" style="font-size:13px;">
                                ...
                                <#list appreciateCategoryList as category>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="${category.image?default("")}" style="width:137px;height:100px;"/>
                                        </td>
                    ...
                    <div class="content form_content" >
                        ...
                        <form action="/cms/appreciate/category/add" method="post">
                            <table class="table_new" style="width:50%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" id="update-url" value="/cms/appreciate/category/{id}/update"/>
                                    </td>
                                </tr>
                            </tbody>
                            </table>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#left_menu_appreciate_category").addClass("selected");
